...
--counters that will count how many correct ans incorrect answers does the user dragged
local correct = 0
local incorrect = 0
...
local function DetermineAlternateAnswers()    
    ...
    alternateAnswer1 = correctAnswer + math.random(5, 7)
    alternateAnswerBox1.text = alternateAnswer1

    -- generate incorrect answer and set it in the textbox
    alternateAnswer2 = correctAnswer - math.random(2, 4)
    ...
    if (answerboxAlreadyTouched == false) and 
        ...
        elseif (touch.phase == "ended") then
            ...
            if (((userAnswerBoxPlaceholder.x - userAnswerBoxPlaceholder.width/2) < alternateAnswerBox1.x ) and 
                ...
                --increase the incorrect counter by 1
...
function scene:create( event )
    ...
    -----------------------------------------------------------------------------------------------------------
    --correct answer
    correctSound = audio.loadStream("Sounds/CorrectAnswer.mp3")
    --wrong answer
    wrongSound = audio.loadStream("Sounds/WrongBuzzer.mp3")
    --background sound
    bkgSound = audio.loadStream("Sounds/background.mp3")
